    ...
    acteursLocaux: [
      {
        ...
        categorie: ActeurLocalCategory.BrocanteurRueNotreDame,
        description: 'Brocante authentique au cœur de la rue Notre-Dame. Meubles vintage, vaisselle et objets de charme.',
        adresse: '45 Cours Portal, 33000 Bordeaux',
